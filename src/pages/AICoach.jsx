...
const AICoach = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'ai',
      text: "Hi! I'm your AI Career Coach. I can help you prepare for interviews, improve your communication skills, and provide personalized career advice. How can I assist you today?",
      timestamp: new Date()
    }
  ]);
  ...
  const aiResponses = {
    behavioral: [
      ...
      "Your answer demonstrates strong problem-solving skills. For even more impact, try quantifying your results."
    ],
    technical: [
    ...
    chat: [
      "I'd be happy to help! What specific aspect of your career would you like to discuss?",
      "That's a great question! Based on your background, here are some strategies I recommend...",
      "I can help you with that. Let's break down your career goals into actionable steps."
    ]
  };
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const responses = aiResponses[selectedMode];
      ...
      const aiMessage = {
        ...
        text: randomResponse,
        timestamp: new Date(),
        feedback: Math.random() > 0.5 ? generateFeedback() : null
      };
